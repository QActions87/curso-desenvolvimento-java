...
#
  ...
  - **Código 18**: [**While-If-Else: Adivinhe o número**](https://github.com/QActions87/curso-desenvolvimento-java/blob/main/estrutura_repeticao/estrutura-repeticao/src/repeticao/WhileStructure.java)
